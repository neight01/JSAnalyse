...
bearbeite den code hier einfach dass er extra zu und .py dateien auch .ahk dateien durchgeht wie geht das ?und in ahk ist ja der code anders also auch bitte einfügen
